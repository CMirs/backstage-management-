<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="purchaseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="题头" align="center" prop="heand" :show-overflow-tooltip="true" />
     <!-- <el-table-column label="内容" align="center" prop="center" :show-overflow-tooltip="true" />-->
    ...
    <el-dialog :title="title1" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="题头" prop="heand">
          <el-input  v-model="form.heand" placeholder="" maxlength="50" />
        </el-form-item>

        <el-form-item label="内容" prop="center">
          <quill-editor ref="text" v-model="form.center" class="myQuillEditor" :options="editorOption" />
        </el-form-item>
...
<script>
  ...
  import { listHelp, add, listcategory, getItem,deletemessage,update } from "@/api/app/help";
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          heand: [
            { required: true, message: "题头不能为空", trigger: "blur" }
          ],
          center: [
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listHelp(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
