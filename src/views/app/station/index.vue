<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="purchaseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="站内消息" align="center" prop="description" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title1" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="站内消息" prop="description">
          <el-input type="textarea" v-model="form.description" placeholder="请输入站内消息，字数限制在100以内" maxlength="100" show-word-limit="" />
        </el-form-item>
...
<script>
  ...
  import { listStation, add, listcategory, getItem,deletemessage,update } from "@/api/app/station";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listStation(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
